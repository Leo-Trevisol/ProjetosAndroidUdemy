...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public class MyCursorAdapter extends CursorAdapter {
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            ...
            view = LayoutInflater.from(context).inflate(R.layout.celula_contato, parent, false);


            TextView name = (TextView) view.findViewById(R.id.textoNome);

            Contato currentContact = cursorToContato(cursor);

            name.setText(currentContact.getName());
            TextView phone = (TextView) view.findViewById(R.id.textoNumero);
            phone.setText(currentContact.getPhone());
            TextView email = (TextView) view.findViewById(R.id.textoEmail);
            email.setText(currentContact.getEmail());
            TextView address = (TextView) view.findViewById(R.id.textoEndereco);
            address.setText(currentContact.getAddress());
            ImageView ivContactImage = (ImageView) view.findViewById(R.id.imagemCelulaContato);
