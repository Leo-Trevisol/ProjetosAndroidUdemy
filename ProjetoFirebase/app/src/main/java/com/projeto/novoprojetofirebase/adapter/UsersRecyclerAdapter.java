package com.projeto.novoprojetofirebase.adapter;
...
import com.projeto.novoprojetofirebase.R;
...
public class UsersRecyclerAdapter extends RecyclerView.Adapter<UsersRecyclerAdapter.ViewHolder> {
    ...
    public UsersRecyclerAdapter(Context context, ArrayList<UserModel> usersItemArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        UserModel users = usersItemArrayList.get(position);

        holder.textName.setText("Name : " + users.getNome());
        holder.textLastName.setText("Sobrenome : " + users.getSobrenome());
        ...
        holder.buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                viewDialogUpdate.showDialog(context, users.getId(), users.getNome(), users.getEmail(), users.getSobrenome());
            }
        });
        ...
        public void showDialog(Context context, String id, String name, String email, String country) {
            ...
            buttonUpdate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String newCountry = textLastName.getText().toString();
                    ...
                    if (name.isEmpty() || email.isEmpty() || country.isEmpty()) {
                        ...
                        if (newName.equals(name) && newEmail.equals(email) && newCountry.equals(country)) {
                            ...
                            databaseReference.child("usuarios").child(id).setValue(new UserModel(id, newName, newEmail, newCountry));
